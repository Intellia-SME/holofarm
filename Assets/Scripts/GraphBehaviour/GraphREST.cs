...
[RequireComponent(typeof(KafkaRESTProxy))]
public class GraphREST : MonoBehaviour
{

    private static GraphREST instance;
    ...
    [SerializeField, Tooltip("Set the Host URI: ")]
    private string topic = "DroneTopic";
    ...
    */
    ...
    private void Awake()
    {
        ...
        */
        ...
        switch (unit)
        {
            case Unit.meters: _units = "m"; break;
            case Unit.feet: _units = "ft"; break;
        }
    ...
    private IEnumerator GetKafkaMessages()
    {
        ...
        */    /*
            yield return new WaitUntil(predicate: () =>
             {
                 Debug.Log("waiting for get method");
                 //Thread.Sleep(100);
            ...
            if (request.isNetworkError || request.isHttpError)
            {
                ...
                //System.Diagnostics.Debug.Write("Graph");
            ...
            else
            {
                ...
                if (message != null)
                {
                    ...
                    string temp = message.GetField(key).ToString();
                    ...
                    if (useBarChart)
                    {
                        ShowGraph(valueList, barChartVisual, -1, (int _i) => (_i + 1).ToString(), (float _f) => Mathf.RoundToInt(_f) +_units);
                    }
                    else
                    {
                        ShowGraph(valueList, lineGraphVisual, -1, (int _i) => (_i + 1).ToString(), (float _f) => _units + Mathf.RoundToInt(_f));
                    }
                }
                //System.Diagnostics.Debug.Write(jsonObject.value);
            }
        }
